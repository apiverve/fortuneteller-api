// Package fortuneteller provides a Go client for the Fortune Teller API.
//
// For more information, visit: https://apiverve.com/marketplace/fortuneteller?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Fortune Teller API.
//
// Parameters:
//   - category: string - Fortune category: general, love, career, health, wealth, travel
//   - question: string - Optional question for personalized fortune (max 500 characters) [maxLength: 500]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"question": {Type: "string", Required: false, MaxLength: intPtr(500)},
	}
...
// ResponseData contains the data returned by the Fortune Teller API.
type ResponseData struct {
	...
	LuckyElement string `json:"luckyElement"`
	LuckyColor string `json:"luckyColor"`
	LuckyDay string `json:"luckyDay"`
