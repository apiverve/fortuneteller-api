...
```gradle
dependencies {
    implementation 'com.github.apiverve:fortuneteller-api:1.1.13'
}
```
...
```java
import com.apiverve.fortuneteller.FortuneTellerAPIClient;
import com.apiverve.fortuneteller.APIResponse;
import com.apiverve.fortuneteller.APIException;

// Initialize the client
FortuneTellerAPIClient client = new FortuneTellerAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("category", "general");
    parameters.put("question", "What does the future hold for me?");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/fortuneteller](https://docs.apiverve.com/ref/fortuneteller)
...
- **Documentation:** [https://docs.apiverve.com/ref/fortuneteller](https://docs.apiverve.com/ref/fortuneteller)
- **Issues:** [GitHub Issues](https://github.com/apiverve/fortuneteller-api/issues)
