...
{
    class FortuneTellerExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/fortuneteller";

        /// <summary>
        /// Make a GET request to the Fortune Teller API
        /// </summary>
        static async Task<JsonDocument> CallFortuneTellerAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;category&quot;] &#x3D; &quot;general&quot;, [&quot;question&quot;] &#x3D; &quot;What does the future hold for me?&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Fortune Teller API...\n");

            var result = await CallFortuneTellerAPI();
